/*
* O número de casas decimais(Radix) e o maior número(Counting) são
* passados por argumento trocar por algoritmo que calcule isto.
*/
import java.util.Arrays;

public class CoutingAndRadixSort {
